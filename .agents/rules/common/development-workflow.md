...
0. **Research & Reuse** _(mandatory before any new implementation)_
   ...
   - **Check package registries:** Search vcpkg, Conan, and GitHub before writing utility code. Prefer battle-tested libraries over hand-rolled solutions.
...
1.5 **Execution Confirmation Gate** _(mandatory — NEVER skip)_
   ...
   - **What requires confirmation**:
     - Creating or deleting CMake targets/modules
